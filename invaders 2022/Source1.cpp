...
public:
    ...
    void game_init()
    {
        ...
        this->textEnemies.setPosition({ 50, 450 });
        ...
        this->textScore.setPosition({ 50, 500 });

        this->helpText.setFont(this->font);
        this->helpText.setCharacterSize(12);
		this->helpText.setFillColor(sf::Color::White);
		this->helpText.setStyle(sf::Text::Bold);
		this->helpText.setPosition({ 50, 0 });
        this->helpText.setString("Shoot enemies, avoid lasers, collect powerups\nLeft, Right - movement\nUp - fire\nF1 - debug mode\nF2 - all powerups");
...
int main()
{
    ...
    // music
    sf::Music menuMusic;
    menuMusic.openFromFile("./assets/sound/music.ogg");
    //menuMusic.openFromFile("./assets/sound/doom.ogg");
